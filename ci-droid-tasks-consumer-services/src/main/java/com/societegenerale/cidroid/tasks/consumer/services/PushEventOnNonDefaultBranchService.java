...
@Slf4j
public class PushEventOnNonDefaultBranchService {
    ...
    public PushEventOnNonDefaultBranchService(RemoteSourceControl gitHub, List<PushEventHandler> pushEventHandlers) {
        this.gitHub = gitHub;
