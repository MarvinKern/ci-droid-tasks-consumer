...
import com.societegenerale.cidroid.tasks.consumer.services.PushEventOnNonDefaultBranchService;
...
public class SourceControlEventListener {
    ...
    private PushEventOnNonDefaultBranchService pushEventOnNonDefaultBranchService;
    ...
    public SourceControlEventListener(PushEventOnDefaultBranchService pushOnDefaultBranchService, PullRequestEventService pullRequestEventService, PushEventOnNonDefaultBranchService pushEventOnNonDefaultBranchService) {
        this.pushOnDefaultBranchService = pushOnDefaultBranchService;
        this.pullRequestEventService = pullRequestEventService;
        this.pushEventOnNonDefaultBranchService = pushEventOnNonDefaultBranchService;
    }
